...
## 9:16 Creative Expansion + Light Mode Default
- [x] Regenerate all ad creatives in 9:16 format with centered content (safe zone for 1:1 crop)
- [x] Add 6 new niches: Concrete/Driveway, Electrical, Fence Installation, Garage Door, Moving Services, Painting
- [x] Expand to 16 niches × 11 angles = 176 total creatives
- [x] Upload all 176 new 9:16 images to CDN
- [x] Rebuild adData.ts with all 176 entries (16 niches × 11 angles)
- [x] Set light mode as default (swap :root to light tokens, .dark to dark tokens in index.css)
- [x] Update App.tsx defaultTheme to "light"
- [x] Fix format preview in detail drawer: true center-crop simulation (not just aspect ratio change)
- [x] Add crop info badge showing % of image visible per format
- [x] Update subtitle to show dynamic count (176 creatives · 16 niches · 11 angles)
- [x] Fix SourceBadge to use correct SourceType values (SwipeFile, AI Pattern, Meta Ad Library)
